...
- 즉, headgear를 입는 경우와 안 입는 경우가 있고 eyewear를 입는 경우와 안입는 경우가 있다.
    - headgear(2), eyewear(1)개일 때 headgear1을 입는 경우, headgear2를 입는 경우, headgear를 모두 안 입는 경우로 총 headgear는 3가지다.
    - eyewear1을 입는 경우, eyewear를 안입는 경우 = 2가지
    - headgear와 eyewear를 고르는 경우는 동시에 발생한다. => 곱의 법칙으로 3 * 2로 총 6가지 경우인데, 여기엔 모두 안입는 경우가 포함되어 있다.
